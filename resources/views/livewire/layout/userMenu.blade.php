                        ...
                        <ul>
                            <li class="relative py-3 mb-3 last:mb-0 bg-light-base-200 dark:bg-base-950" x-data="{ index: 1 }">
                                ...
                                <div class="relative overflow-hidden transition-all duration-700" x-show="isSelected(index)" x-collapse>
                                    <div class="flex flex-col gap-3 pt-3">
                                        <p>
                                            <span class="font-semibold">{{ __('Vaults') }}</span>:
                            ...
                            <li class="relative py-3 mb-3 last:mb-0 bg-light-base-200 dark:bg-base-950" x-data="{ index: 2 }">
                                ...
                                <div class="relative overflow-hidden transition-all duration-700" x-show="isSelected(index)" x-collapse>
                                    <div class="flex flex-col gap-3 pt-3">
                                        <p>
                                            <span class="font-semibold">{{ __('Importing vaults') }}</span>:
                                        ...
                                        <p>
                                            <span class="font-semibold">{{ __('Exporting vaults') }}</span>:
